...
> **Остання версія проекту:** v0.3.064-dev
...
Найвища цінність: **AUD-L1** (вирішено, розблоковує не-українські проєкти) і **AUD-L2/L3** (ядро якості перекладу — збереження структури й позиційних тегів). Це складні логічні зміни — робити ітеративно, з прикладами в промпті та тестами на round-trip структури. **AUD-EXP1** (вирішено) і **AUD-Q1** — швидкі незалежні перемоги.
