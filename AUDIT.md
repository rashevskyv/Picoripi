...
> **��������� ������:** 2026-05-23 - ����������� ����������� ������������ ������� BFN-������ � ����� �� ������ ������� ��� ����� ��������, ���������� ��������� ��������� ������������ � BFN Editor ������ � all_bfn_fonts ��������� ���� �� �������� �� �������� ��� ��������� �����������, ����������� ������� Fallback-���� ������� �������� BFN-������ ��� ����� ��� �������, ���������� ���� ������ ������� �������� ������ (mapping_type = 0) ������ ���������� ����������� ����������� � ��� 2 �� ��� �������� MAP1 � BfnCore �� ����������� ��������� ���������� ��������� �����.
...
| 18 | Впроваджено HSL-стилювання Light Theme меню, додано тултіпи для заблокованих пунктів, виправлено сигнал Import Directory та синхронізацію початкового стану кнопки Close Project | ✅ | v0.2.84-dev |�:
