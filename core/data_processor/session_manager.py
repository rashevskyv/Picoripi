...
class SessionManager:
    ...
    def serialize_session_to_json(self, snapshot: dict) -> dict:
        ...
        json_snapshot = {
            ...
            "current_view_kind": snapshot.get("current_view_kind", "physical"),
            ...
            "current_chapter_id": snapshot.get("current_chapter_id"),
            "chapter_mappings": snapshot.get("chapter_mappings", []),
    ...
    def deserialize_session_from_json(self, json_data: dict) -> dict:
        ...
        snapshot = {
            ...
            "current_view_kind": json_data.get("current_view_kind", "physical"),
            ...
            "current_chapter_id": json_data.get("current_chapter_id"),
            "chapter_mappings": json_data.get("chapter_mappings", []),
            ...
            try:
                ...
                if pickle_snapshot and not isinstance(pickle_snapshot, dict):
                    ...
                    pickle_snapshot = {
                        ...
                        "current_view_kind": getattr(
                            restored_store.__dict__.get("current_view_kind", "physical"),
                            "value",
                            restored_store.__dict__.get("current_view_kind", "physical"),
                        ),
                        ...
                        "current_chapter_id": restored_store.__dict__.get("current_chapter_id"),
                        "chapter_mappings": restored_store.__dict__.get("chapter_mappings", []),
