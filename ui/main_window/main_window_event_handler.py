...
class MainWindowEventHandler:
    ...
    def connect_signals(self):
        ...
        if hasattr(self.mw, 'pipeline_wizard_action') and self.mw.pipeline_wizard_action:
            self.mw.pipeline_wizard_action.triggered.connect(self.mw.actions.open_pipeline_wizard)
    ...
    def disconnect_signals(self):
        ...
        if hasattr(mw, 'pipeline_wizard_action'): safe_disconnect(mw.pipeline_wizard_action, 'triggered')
