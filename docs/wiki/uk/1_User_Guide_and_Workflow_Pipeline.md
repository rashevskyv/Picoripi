...
Вибір і застосування запропонованого варіанта перекладу оновлює готовий індекс входжень на місці, якщо термін і категорія не змінилися. Тому підтвердження лишається швидким і у великих проєктах; зміна терміна/категорії або підтвердження до побудови індексу все ще запускає повне сканування заради коректності.
